...
# checkpoint_name
checkpoint_name = 'mAT_'+args.network+'_'+args.dataset+'_'+date_time+'.pth'
...
def train():
    ...
    for epoch in range(args.epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(tqdm(trainloader)):
            ...
            cross_entropy_loss = 1/2*cross_entropy(net(adv_x), targets)+1/2*cross_entropy(net(inputs), targets)
            ...
            if batch_idx % 50 == 0 and batch_idx != 0:
                print('[mAT/Train] Iter: {}, Acc: {:.3f}, CE: {:.3f}'.format(
                    batch_idx, # Iter
...
def adversarial_test():
    ...
    print('\n\n[mAT/Test] Under Testing ... Wait PLZ')
    ...
    print('[mAT/Test] Acc: {:.3f}'.format(100.*correct / total))
